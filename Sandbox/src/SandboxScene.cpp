...
void SandboxScene::onLoad()
{
	...
	Fracture::ComponentManager::AddComponent<Fracture::TransformComponent>(monkey->Id, glm::vec3(0.0f), glm::vec3(0.5f));
	...
	std::shared_ptr<Fracture::Entity> floor = Fracture::EntityManager::CreateEntity<Fracture::Entity>();
	floor->name = "Floor";

	Fracture::ComponentManager::AddComponent<Fracture::TransformComponent>(floor->Id, glm::vec3(0,-10,0), glm::vec3(1.0f));
	Fracture::ComponentManager::AddComponent<Fracture::TagComponent>(floor->Id);
	Fracture::ComponentManager::AddComponent<Fracture::BoxColliderComponent>(floor->Id, 50, 2, 50);
	Fracture::ComponentManager::AddComponent<Fracture::RigidBodyComponent>(floor->Id, 0.0f);
	...
	for (unsigned int i = 0; i < 10; i++)
	{
		...
		cube->name = "cube";
		Fracture::ComponentManager::AddComponent<Fracture::TransformComponent>(cube->Id, cubePositions[i], glm::vec3(1.0f));
