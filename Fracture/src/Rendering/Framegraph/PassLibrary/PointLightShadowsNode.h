...
namespace Fracture
{
	...
	{
	public:
		PointShadowsNode(const std::string& name, const int& width, const int& height, const std::shared_ptr<RenderBucket>& bucket, const std::shared_ptr<PointLight>& light);
