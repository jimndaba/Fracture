...
Fracture::PickingPass::PickingPass(std::string Name, int width, int height):RenderQueuePass(Name),SCREEN_WIDTH(width),SCREEN_HEIGHT(height)
{
...
void Fracture::PickingPass::Reset()
{
}
