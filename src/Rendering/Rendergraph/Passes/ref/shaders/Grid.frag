...
vec4 gridColorThick = vec4(0.2235, 0.0, 0.0, 1.0);
...
vec4 gridColor(vec2 uv)
{
	...
	vec4 c = lod2a > 0.0 ? gridColorThick : lod1a > 0.0 ? mix(gridColorThick, gridColorThin, lodFade) * opacityFalloff : gridColorThin * opacityFalloff;
